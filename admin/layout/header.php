          ...
          <div class="navbar">
            <div class="container-xl">
              <ul class="navbar-nav">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="../data_users/users.php" >
                    <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
                  ...
                  <div class="dropdown-menu">
                    <div class="dropdown-menu-columns">
                      <div class="dropdown-menu-column">
                        <a class="dropdown-item" href="../data_jaba../tan/jabatan.php">
                          Jabatan
                        </a>
                        <a class="dropdown-item" href="../data_lokasi_presensi/lokasi_presensi.php">
                          Lokasi Presensi
                        </a>
                      </div>
                    </div>
